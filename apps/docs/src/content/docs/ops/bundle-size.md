...
|------------|-----------------------------|----------|------------------|
| store-kit  | `index.mjs`                 | 2 KB     | ~1.4 KB |
| fetch-kit  | `index.mjs`                 | 3 KB     | ~2.5 KB |
| fetch-kit  | `react.mjs`                 | 1.5 KB   | ~0.8 KB |
| log-kit    | `index.mjs`                 | 2 KB     | ~1.4 KB |
| log-kit    | `transports/console.mjs`    | 1 KB     | ~0.6 KB |
| log-kit    | `transports/http.mjs`       | 1.5 KB   | ~0.6 KB |
| log-kit    | `transports/file.mjs`       | 1 KB     | ~0.4 KB |
| log-kit    | `transports/datadog.mjs`    | 1 KB     | ~0.9 KB |
