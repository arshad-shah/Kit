...
[![Docs](https://github.com/arshad-shah/kit/actions/workflows/docs.yml/badge.svg)](https://kit.arshadshah.com)

## Packages

| Package | Description | Size (gzipped) |
|---|---|---|
| [`@arshad-shah/store-kit`](./packages/store-kit) | Typed Zustand factory with persistence and migrations | ~1.4 KB |
| [`@arshad-shah/fetch-kit`](./packages/fetch-kit) | Typed `fetch` client with retries, schema validation, React hooks | ~2.5 KB core, ~0.8 KB hooks |
| [`@arshad-shah/log-kit`](./packages/log-kit) | Structured logger with pluggable transports and perf markers | ~1.4 KB core |
